    ...
    return (
        <React.Fragment>
            ...
            <div className={css(props.style)}>
                <UniText size={14} containerStyle={styles.topText}>
                    {props.batchStr}
                </UniText>
                {props.individualsCount && (
...
UniTabRowBatchStr.defaultProps = {
    // type: "input",
    // label: null,
    // required: false,
};

UniTabRowBatchStr.propTypes = {
    // type: PropTypes.oneOf(["input", "textarea", "password"]),
    // label: PropTypes.string,
    // required: PropTypes.bool,
};

export default UniTabRowBatchStr;

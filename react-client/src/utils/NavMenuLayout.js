    ...
    <React.Fragment>
      <Layout className={css(styles.mask)}>
        <Layout.Header className={css(styles.headerContainer)}>
          ...
          {/* <div
                    className={css(styles.logoutContainer)}
                    onClick={() => {
                        handleLogout();
                    }}
                >
        ...
        <Layout>
          {showMenu && (
            <Layout.Sider width="200px" className={css(styles.container)}>
              <div className={css(styles.menuWrapper)}>
                {userType === userRoleEnum.Admin ? (
                  ...
                  <Menu
                    ...
                    // }}
                  >
                    {VerticalMenuItem(CandidateMenuArray)}
                  </Menu>
                ) : null}
              </div>
            </Layout.Sider>
          ...
          <Layout className={css(styles.layout)}>
            ...
            {showMenu && userType === userRoleEnum.Candidate ? (
